...
import { useAddBlogMutation } from "../../../store/slices/apiSlice";
...
const AddBlogPost: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    console.log("Saving blog post:", res)
    setIsSaving(false)
  ...
  const renderMarkdown = (text: string): string => {
    ...
    // Convert headings
    html = html.replace(/^## (.*$)/gm, '<h2 class="text-2xl font-bold text-gray-900 mb-4 mt-6">$1</h2>')
    html = html.replace(/^### (.*$)/gm, '<h3 class="text-xl font-bold text-gray-900 mb-3 mt-5">$1</h3>')
  ...
  return (
    <div className="add-blog-post min-h-screen bg-gray-50">
      {/* Header */}
      <div className="blog-header bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="blog-page-title text-xl sm:text-2xl font-bold text-gray-900">Add New Blog Post</h1>
          ...
          {!isPreviewMode ? (
            ...
            <>
              ...
              <div className="image-section bg-white rounded-lg border border-gray-200 p-6">
                <label className="form-label block text-sm font-medium text-gray-700 mb-3">Featured Image</label>
                ...
                {!imagePreview ? (
                  ...
                  >
                    <div className="upload-content space-y-4">
                      ...
                      <div>
                        <p className="upload-text text-lg font-medium text-gray-900 mb-2">Upload Featured Image</p>
                        <p className="upload-subtext text-sm text-gray-600">Drag and drop or click to browse</p>
                        <p className="upload-formats text-xs text-gray-500 mt-2">Supports: JPG, PNG, GIF (Max 5MB)</p>
                      </div>
                    </div>
                  </div>
                ) : (
