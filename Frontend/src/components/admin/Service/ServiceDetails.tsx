    ...
    <div className="admin-service-details min-h-screen bg-gray-50">
      ...
      {service ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      <span
                        className={`admin-status-badge px-2 py-1 text-xs font-medium rounded-full ${service.status === "active" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                          }`}
                      >
                  ...
                  <div className="admin-info-card bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div className="admin-info-items space-y-4">
                      <div className="admin-info-item">
                        ...
                        <span
                          className={`admin-info-value block text-sm font-medium ${service.status === "active" ? "text-green-600" : "text-gray-600"
                            }`}
                        >
                          {service.status === "active" ? "Active" : "Inactive"}
                        </span>
        ...
        <div className="flex items-center justify-center min-h-screen">
          <p className="text-gray-500 text-lg font-medium">No service found</p>
        </div>
