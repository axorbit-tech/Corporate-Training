    ...
    <section className="blog-section bg-gray-50 py-10 lg:py-10">
      <div className="mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <div className="text-center mb-12">
          <h2 className="blog-main-heading text-3xl font-bold text-blue-600 mb-2">
            Our Blogs
          </h2>
          {/* Blue underline */}
        ...
        <div className="text-center mb-16">
          <p className="blog-subheading text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
            Every post is crafted to deliver value, offering actionable advice
          ...
          {blogPosts?.slice(0, 2).map((post) => (
            ...
            >
              <div className="flex flex-col sm:flex-row">
                {/* Image */}
                <div className="sm:w-1/3 h-60 overflow-hidden">
                  <img
