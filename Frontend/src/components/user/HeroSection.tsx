              ...
              <div className="rounded-2xl p-6 sm:p-8 lg:p-10max-w-2xl mx-auto lg:mx-0">
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="pt-4 sm:pt-6">
                    <a
                      href="/book-session"
                      className="hero-cta-btn inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 lg:px-16 lg:py-4 rounded-full font-semibold text-sm sm:text-base lg:text-lg tracking-wide transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    >
                      Book A Session
                    </a>
                  </div>
